    ...
    <>
      ...
      <main>
          ...
          <div className="about-person">
            ...
            <div className="about-me-info">
              <p id="about-me-info">
                ...
                Bachelor of Science in Information Technology as 3rd year
                student. A passionate and detail-driven web developer with a
                strong foundation in front-end technologies like{" "}
                <strong>HTML, CSS, JavaScript, and ReactJS. </strong>
                I love creating clean, responsive, and user-friendly websites
                that blend function and design. My focus is on writing
                efficient, maintainable code and continuously learning to
                improve my skills.
                <br />
                <br />
                I'm currently expanding my knowledge in back-end development to
                become a full-stack developer. Outside of coding, I enjoy
        ...
        <section id="skills" className="bg-gray-700">
          <br />
          <h1 className="text-3xl font-bold text-center">MY TECHNOLOGIES</h1>
          <br />
        ...
        <section id="projects" className="bg-gray-700 py-16 text-white">
          <h1 className="text-3xl font-bold text-center mb-15">My Projects</h1>
          <br />
          <hr id="line" />
          <br />
          ...
          {/* UI/UX projects */}
          <br />
          <h1 className="text-2xl font-bold text-center mb-12">UI/UX</h1>
          <br />
          ...
          <div className="flex flex-wrap justify-center items-center gap-8">
            ...
            <div
              className="hover:cursor-pointer transform hover:scale-105 transition-transform duration-300 relative bg-cover bg-no-repeat bg-center h-[200px] w-full max-w-[400px] rounded-xl shadow-md overflow-hidden"
              style={{ backgroundImage: `url(${UI4})` }}
            >
              <div className="overlay-background"></div>
              <div className="project-build relative z-10 flex flex-col items-center justify-center h-full text-center text-white p-4">
                <h1 className="text-lg font-semibold">FootPrint</h1>
                <p className="text-lg mb-3">UI/UX</p>
                ...
                <div className="flex justify-center content-center items-center gap-5">
                  <a href="https://www.figma.com/design/nFjGBTsfSLcjGocKTC5kWu/Figma-mobile-app?node-id=102-87&t=CPrUZY6luInjSrnQ-1">
                    <i class="fa-solid fa-eye text-2xl hover:text-4xl duration-100"></i>
                  </a>
                </div>
              </div>
      ...
      <footer className="bg-gray-700 text-center flex justify-center">
        <p className="drop-shadow-lg">
          &copy; DevByte {new Date().getFullYear()}
        </p>
      </footer>
    </>
  );
