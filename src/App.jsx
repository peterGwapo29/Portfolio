    ...
    <>
        <header className="relative bg-gray-900 h-[70px] px-6 flex items-center justify-between">
            <div className="logo absolute left-6">
                <img src={logo} alt="logo" className="h-10 drop-shadow-lg logo-bec" />
            </div>
            ...
            <section id="skills" className="bg-gray-700"><br />
                ...
                <div className="flex flex-col items-center gap-12 px-6">
                    ...
                    <div className="flex flex-wrap justify-center gap-8">
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/html5/html5-original.svg" className="h-[80px] drop-shadow-lg" />
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/css3/css3-original.svg" className="h-[80px] drop-shadow-lg" />
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/javascript/javascript-original.svg" className="h-[80px] drop-shadow-lg" />
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tailwindcss/tailwindcss-original.svg" className="h-[80px] drop-shadow-lg" />
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original-wordmark.svg" className="h-[80px] drop-shadow-lg" />
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/typescript/typescript-original.svg" className="h-[80px] drop-shadow-lg"/>
                    </div>
                    </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-8">
                        ...
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/mysql/mysql-original-wordmark.svg" className="h-[80px] drop-shadow-lg" />
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/mongodb/mongodb-original-wordmark.svg" className="h-[80px] drop-shadow-lg"/>
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/postgresql/postgresql-original-wordmark.svg" className="h-[80px] drop-shadow-lg"/>
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/sqlite/sqlite-original.svg" className="h-[80px] drop-shadow-lg"/>
                    </div>
                    </div>
                    ...
                    <div className="w-full max-w-5xl">
                        ...
                        <div className="flex flex-wrap justify-center gap-8">
                            ...
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/github/github-original-wordmark.svg" className="h-[80px] drop-shadow-lg" />
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/postman/postman-original.svg" className="h-[80px] drop-shadow-lg" />
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/figma/figma-original.svg" className="h-[80px] drop-shadow-lg" />
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/java/java-original-wordmark.svg" className="h-[80px] drop-shadow-lg" />
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/vercel/vercel-original-wordmark.svg"  className="h-[80px] drop-shadow-lg"/>
                        </div>
                    </div>
                ...
                <div className="flex flex-wrap justify-center items-center gap-8">
                    ...
                    <div
                        ...
                        <div className="project-build relative z-10 flex flex-col items-center justify-center h-full text-center text-white p-4">
                            ...
                            <p className="text-lg mb-3">Admin module only</p>
        ...
        <footer className='bg-gray-700 text-center flex justify-center'>
            <p className='drop-shadow-lg'>&copy; DevByte { new Date().getFullYear() }</p>
        </footer>
